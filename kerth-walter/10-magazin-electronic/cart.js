...
function drawCart(){
    event.preventDefault(); 
        ...
        xhttp.open("GET", "https://magazin-online-6cafb.firebaseio.com/.json", true);
        xhttp.send();
...
function maiMare(index,cantitate){
    ...
    if (parseInt(listaProduse.cart[index].cantitate+1)<=parseInt(listaProduse.cart[index].stoc)) {
            ...
            xhttp.open("PUT","https://magazin-online-6cafb.firebaseio.com/cart/" + index +"/cantitate.json", true);
...
function sterge(index) {
        ...
        xhttp.open("DELETE",  "https://magazin-online-6cafb.firebaseio.com/cart/" + index +".json", true);
        xhttp.send();
        document.getElementById("loading").style.display="";
    }
...
function stergeCos() {
    ...
    xhttp.onreadystatechange = function() {
        ...
        xhttp.open("DELETE",  "https://magazin-online-6cafb.firebaseio.com/cart/.json", true);
        xhttp.send();
        document.getElementById("loading").style.display="";
}
...
function modifCant(){
 for (var i in listaProduse.cart){
    ...
    var xhttp = new XMLHttpRequest();
        ...
        xhttp.open("PUT", "https://magazin-online-6cafb.firebaseio.com/menu/" + i +"/cantitate.json", true);           
