...
function drawLista() {
    ...
    xhttp.open("GET", "https://magazin-online-6cafb.firebaseio.com/menu/"+window.location.search.substring(4)+".json", true);
    xhttp.send();
...
function adaugaProdus(){
    ...
    if(detaliuProduse.cantitate>0) { 
      ...
      var xhttp = new XMLHttpRequest();
            ...
            xhttp.open("PUT", "https://magazin-online-6cafb.firebaseio.com/cart/" +window.location.search.substring(4) + ".json", true);           
...
function verificaProdus(form,event){
    ...
    var xhttp = new XMLHttpRequest();
            ...
            xhttp.open("GET", "https://magazin-online-6cafb.firebaseio.com/cart/.json", true);           
            xhttp.send();                 
}